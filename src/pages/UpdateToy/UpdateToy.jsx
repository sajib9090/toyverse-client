    ...
    return (
      ...
      <div className="w-[70%] bg-white mx-auto shadow-xl">
        <div className="py-10 px-4 ">
          <h2 className="text-4xl font-bold text-[#68B5D2]">Edit/Update A Toy.</h2>
          <h1 className="text-xl font-semibold py-3 text-[#EF7B84]">
            Let's edit/update your Toy.
          </h1>
        </div>
          ...
          <div className="grid grid-cols-2 gap-6 px-6">
            ...
            <div>
              ...
              <div>
                ...
                <br />
                <select name="category" id="" value={data?.category} required className="w-[100%] mt-3 mb-2 input input-bordered">
